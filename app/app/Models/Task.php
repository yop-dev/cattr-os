...
class Task extends Model implements AttachmentAble
{
    ...
    protected static function boot(): void
    {
        ...
        // BUG-010 fix: use syncWithoutDetaching instead of firstOrCreate on the pivot.
        // firstOrCreate on a BelongsToMany tries to INSERT a new User row when the user
        // isn't already in the pivot — missing required columns → SQL constraint → 500.
